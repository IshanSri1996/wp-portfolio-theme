...
$( document ).ready(function() { 
    ...
    $(".submit").click(function(e){
        let obj = {action: 'set_content', id: $("#id").val(), filepath: $("#filepath").val(), title: $("#title").val(), sub_title: $("#sub_title").val(), width: $("#width").val(), height: $("#height").val(), label: $("#label").val(), color: $("#color").val(), url: $("#url").val(), tags: $("#tags").val(), status: $("#status").val(), content: CKEDITOR.instances.content.getData() };
