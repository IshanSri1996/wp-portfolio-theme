					...
					<div class="row justify-content-center">	
						<div class="col-md-10 col-lg-8">
							<div class="section-title title-02 mb-80">			
								...
								<!-- Title -->	
								<h2 class="h2-xs">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h2>	

								<!-- Text -->	
								<p class="p-xl">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
								</p>	
		 						...
		 						<a href="pricing.html">
			 						<div class="cta-box cta-top-box bg-white wow fadeInUp">
										...
										<div class="cta-txt">
											...
											<!-- Title -->
											<h5 class="h5-md">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h5>
												
											<!-- Text -->
											<p class="p-lg">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
											</p>
		 						...
		 						<a href="faqs.html">
			 						<div class="cta-box bg-white wow fadeInUp">
										...
										<div class="cta-txt">
											...
											<!-- Text -->
											<p class="p-lgIt is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
											</p>
